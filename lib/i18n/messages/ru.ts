...
const ru: Messages = {
  ...
  validate: {
    ...
    proofRequiredTitle: "Подтверждение обязательно",
    proofRequiredHint:
      "После оплаты обязательно сделайте снимок экрана квитанции. Без этого подтверждения перевод не будет принят.",
    proofHint:
      "Добавьте одно или несколько подтверждений (JPG, PNG, WEBP или PDF, макс. 10 МБ).",
    confirming: "Подтверждение...",
    timerLabel: "Оставшееся время",
    timerHint:
      "Пожалуйста, совершите платёж и загрузите подтверждение в этот срок. Курс обмена гарантирован в течение 30 минут.",
    timerExpired:
      "Срок в 30 минут истёк. Курс больше не гарантирован — совершите платёж как можно скорее.",
    timerAria: "Оставшееся время для оплаты: {time}",
  },
  chatbot: {
    greeting:
      "Здравствуйте! Я помощник AFRU-E. Задайте вопросы о переводах, комиссиях или вашем аккаунте.",
    promptTransfer: "Как сделать перевод?",
    promptAbout: "Что такое AFRU-E?",
    errorFallback:
    ...
    sendAria: "Отправить",
    waiting: "Оператор скоро ответит.",
    waitingSubtitle: "В очереди",
    ...
    fileWrongStatus: "Файл можно отправить, когда оператор на линии.",
    closedHint: "Диалог закрыт. Отправьте сообщение, чтобы начать снова.",
