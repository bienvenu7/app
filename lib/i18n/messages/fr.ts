const fr = {
  ...
  chatbot: {
    ...
    transactionProblem: "Problème avec une transaction",
    errorFallback:
    ...
    sendAria: "Envoyer",
    waiting: "Un agent va vous répondre.",
    waitingSubtitle: "En file d'attente",
    ...
    fileWrongStatus: "Joignez un fichier une fois un agent en ligne.",
    closedHint: "Conversation terminée. Envoyez un message pour recommencer.",
